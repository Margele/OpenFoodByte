...
public class IRCCommand extends Command {
   ...
   public IRCCommand() {
      super(new String[]{Method2017(-21079, -16469), "i"});
      this.setHelp(Method2017(-21087, 32361));
   }
      ...
      if (!this.Method2357(a)) {
         if (a.startsWith(Method2017(-21088, -31357))) {
            ...
            if (!EventManager.Method2679(Class604.class)) {
               GlobalModule.INSTANCE.balant.Method3702();
            }
   ...
   private static String Method2017(int integer1, int integer2) {
      int var2 = (integer1 ^ -21087) & '\uffff';
      if (Field2928[var2] == null) {
         char[] var3 = Field2927[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 199;
         ...
         Field2928[var2] = (new String(var3)).intern();
      }

      return Field2928[var2];
   }

   // $FF: synthetic method
   private static native void Method2359();
}
