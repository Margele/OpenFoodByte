...
public class RotationUtils {
    public static float[] getRotation2(EntityLivingBase a) {
        ...
        return RotationUtils.Method1166(a2, a3, a4);
    }
    ...
    public static float[] Method1174(EntityLivingBase a) {
        if (RotationUtils.Method1175()) {
            return RotationUtils.Method1173(a.posX + MathUtils.getRandomDouble3(0.03, -0.03), a.posY + (double)a.getEyeHeight() - 0.4 + MathUtils.getRandomDouble3(0.07, -0.07), a.posZ + MathUtils.getRandomDouble3(0.03, -0.03));
        }
        return RotationUtils.Method1173(a.posX, a.posY + (double)a.getEyeHeight() - 0.4, a.posZ);
    }
