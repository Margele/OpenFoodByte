...
extends Module {
    ...
    public AutoGG() {
        ...
        if (Class91.Method3648() == null) {
            Class448.Method2460(new Class91[4]);
        }
    }
    ...
    public void Method273(EventPacket a) {
        if (a.getPacket() instanceof S02PacketChat) {
            S02PacketChat a2 = (S02PacketChat)a.getPacket();
            if (Arrays.stream((Object[])this.Field2172).anyMatch(arg_0 -> AutoGG.Method2075(a2, arg_0)) && EnumChatFormatting.getTextWithoutFormattingCodes((String)a2.getChatComponent().getUnformattedText()).startsWith(" ")) {
                ++this.Field2174;
                if (this.Field2174 > 3) {
                    this.Field2174 = 0;
                }
    ...
    private static boolean Method2075(S02PacketChat a, String a2) {
        return EnumChatFormatting.getTextWithoutFormattingCodes((String)a.getChatComponent().getUnformattedText()).contains((CharSequence)a2.toString());
    }
}