...
extends Module {
    ...
    private static String Method754(int n, int n2) {
        int n3 = (n ^ 0xFFFFB14B) & 0xFFFF;
        if (Field3115[n3] == null) {
            int n4;
            char[] cArray = Field3114[n3].toCharArray();
            ...
            AutoMelody.Field3115[n3] = new String(cArray).intern();
        }
        return Field3115[n3];
    }
    ...
    static {
        ...
        AutoMelody.Method2057();
    }

    public AutoMelody() {
        super(AutoMelody.Method754(-20151, -4589), AutoMelody.Method754(-20159, 13562), Category.SKYBLOCK);
        this.setDescription(AutoMelody.Method754(-20149, 22290));
    }
    ...
    private static native /* synthetic */ void Method2057();
}