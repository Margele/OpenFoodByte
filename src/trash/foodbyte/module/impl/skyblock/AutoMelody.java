...
public class AutoMelody extends Module {
   public TimeHelper Field3111 = new TimeHelper();
   public static BooleanValue Field3112;
   public static BooleanValue Field3113;
   private static final String[] Field3114;
   private static final String[] Field3115;
   ...
   private static String Method754(int integer1, int integer2) {
      int var2 = (integer1 ^ -20149) & '\uffff';
      if (Field3115[var2] == null) {
         char[] var3 = Field3114[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 39;
         ...
         Field3115[var2] = (new String(var3)).intern();
      }

      return Field3115[var2];
   }

   static {
      Class614.Method2232(8, AutoMelody.class);
      Method2057();
   }

   public AutoMelody() {
      super(Method754(-20151, -4589), Method754(-20159, 13562), Category.SKYBLOCK);
      this.setDescription(Method754(-20149, 22290));
   }
   ...
   public void Method1994(EventMove a) {
      if (Class484.Field2234.equals(Class615.DUNGEON) && Field3113.getBooleanValue()) {
   ...
   // $FF: synthetic method
   private static native void Method2057();
}
