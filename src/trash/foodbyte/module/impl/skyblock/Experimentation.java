...
public class Experimentation extends Module {
   ...
   public Experimentation() {
      super(Method754(-5058, 22689), Category.SKYBLOCK);
      this.setDescription(Method754(-5065, 884));
   }
   ...
   private static String Method754(int integer1, int integer2) {
      int var2 = (integer1 ^ -5068) & '\uffff';
      if (Field3116[var2] == null) {
         char[] var3 = Field3121[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 62;
         ...
         Field3116[var2] = (new String(var3)).intern();
      }

      return Field3116[var2];
   }

   @Class628
   public native void Method1656(Container container, String string, int integer, List list, IInventory iInventory);
