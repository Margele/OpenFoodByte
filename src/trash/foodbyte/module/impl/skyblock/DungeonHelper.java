...
public class DungeonHelper extends Module {
   ...
   public void idk() {
      Field3246.Method2757(Field3247.isCurrentMode(Method754(-11422, -9067)));
   }
   ...
   public DungeonHelper() {
      super(Method754(-11410, 3174), Method754(-11409, -21921), Category.SKYBLOCK);
      this.setDescription(Method754(-11419, -31315));
   }
   ...
   private static String Method754(int integer1, int integer2) {
      int var2 = (integer1 ^ -11416) & '\uffff';
      if (Field3242[var2] == null) {
         char[] var3 = Field3245[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 52;
         ...
         Field3242[var2] = (new String(var3)).intern();
      }

      return Field3242[var2];
   }
