...
extends Module {
    ...
    @Class628
    public native void Method760(Class633 var1);
    ...
    private static String Method754(int n, int n2) {
        int n3 = (n ^ 0xFFFFE717) & 0xFFFF;
        if (Field2550[n3] == null) {
            int n4;
            char[] cArray = Field2551[n3].toCharArray();
            ...
            LegitSpeed.Field2550[n3] = new String(cArray).intern();
        }
        return Field2550[n3];
    }
    ...
    public static double Method763(double a, double a2) {
        ...
        BigDecimal a3 = new BigDecimal(a);
        a3 = a3.setScale((int)a2, RoundingMode.HALF_UP);
        return a3.doubleValue();
    }

    @Override
    public boolean canUse() {
        return GlobalModule.INSTANCE.Field3186 == null || !PermissionManager.canUseModule(LegitSpeed.Method754(-6382, -18331));
    }

    public LegitSpeed() {
        boolean bl = Class167.Method1500();
        super(LegitSpeed.Method754(-6381, 3629), LegitSpeed.Method754(-6379, -8458), Category.MOVEMENT);
        boolean bl2 = bl;
    ...
    public static int Method242() {
        if (LegitSpeed.mc.thePlayer.isPotionActive(Potion.moveSpeed) && LegitSpeed.mc.thePlayer.getActivePotionEffect(Potion.moveSpeed).getDuration() > 5) {
            return LegitSpeed.mc.thePlayer.getActivePotionEffect(Potion.moveSpeed).getAmplifier() + 1;
        }
        return 0;
    }
    ...
    static {
        ...
        LegitSpeed.Method764();
    }

    private static native /* synthetic */ void Method764();
}