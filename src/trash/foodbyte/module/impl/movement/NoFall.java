...
extends Module {
    ...
    public ModeValue Field2543 = new ModeValue(NoFall.Method754(-12057, 19860), NoFall.Method754(-12052, 3963), NoFall.Method754(-12056, 28981), new String[]{NoFall.Method754(-12063, 13966), NoFall.Method754(-12051, -8342), NoFall.Method754(-12050, 1541)}, NoFall.Method754(-12055, -27588));
    public boolean Field2544;
    public boolean Field2545;
    private static final String[] Field2546;
    ...
    public String getDescription() {
        return NoFall.Method754(-12049, -9230);
    }

    @Class628
    public native void Method752(EventMotion var1);

    @Override
    public boolean canUse() {
        return GlobalModule.INSTANCE.Field3186 == null || !PermissionManager.canUseModule(NoFall.Method754(-12058, 2961));
    }

    private static String Method754(int n, int n2) {
        int n3 = (n ^ 0xFFFFD0E5) & 0xFFFF;
        if (Field2547[n3] == null) {
            int n4;
            char[] cArray = Field2546[n3].toCharArray();
            ...
            NoFall.Field2547[n3] = new String(cArray).intern();
        }
        return Field2547[n3];
    }
    ...
    static {
        Class614.Method2232(5, NoFall.class);
        NoFall.Method756();
    }

    public NoFall() {
        super(NoFall.Method754(-12062, 4650), NoFall.Method754(-12061, 3040), Category.MOVEMENT);
        this.setHideModule(true);
    }

    private static native /* synthetic */ void Method756();
}