...
public class NoFall extends Module {
   ...
   public ModeValue Field2543 = new ModeValue(Method754(-12057, 19860), Method754(-12052, 3963), Method754(-12056, 28981), new String[]{Method754(-12063, 13966), Method754(-12051, -8342), Method754(-12050, 1541)}, Method754(-12055, -27588));
   ...
   public String getDescription() {
      return Method754(-12049, -9230);
   }

   @Class628
   public native void Method752(EventMotion class631);

   public boolean canUse() {
      return GlobalModule.INSTANCE.balant == null || !PermissionManager.canUseModule(Method754(-12058, 2961));
   }

   private static String Method754(int integer1, int integer2) {
      int var2 = (integer1 ^ -12059) & '\uffff';
      if (Field2547[var2] == null) {
         char[] var3 = Field2546[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 231;
         ...
         Field2547[var2] = (new String(var3)).intern();
      }

      return Field2547[var2];
   }
   ...
   public NoFall() {
      super(Method754(-12062, 4650), Method754(-12061, 3040), Category.MOVEMENT);
      this.setHideModule(true);
   }

   // $FF: synthetic method
   private static native void Method756();
}
