...
Class45 {
    ...
    private static String Method1357(int n, int n2) {
        int n3 = (n ^ 0x1474) & 0xFFFF;
        if (Field2071[n3] == null) {
            int n4;
            char[] cArray = Field2070[n3].toCharArray();
            ...
            Class433.Field2071[n3] = new String(cArray).intern();
        }
        return Field2071[n3];
    }
    ...
    private static native /* synthetic */ void Method2345();
}