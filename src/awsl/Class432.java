...
Class45 {
    ...
    private static String Method1357(int n, int n2) {
        int n3 = (n ^ 0xFFFFA8D5) & 0xFFFF;
        if (Field2069[n3] == null) {
            int n4;
            char[] cArray = Field2068[n3].toCharArray();
            ...
            Class432.Field2069[n3] = new String(cArray).intern();
        }
        return Field2069[n3];
    }

    private static native /* synthetic */ void Method2333();
}