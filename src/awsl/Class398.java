...
public class Class398 implements Class422, Class45 {
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ 32164) & '\uffff';
      if (Field1962[var2] == null) {
         char[] var3 = Field1964[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 95;
         ...
         Field1962[var2] = (new String(var3)).intern();
      }

      return Field1962[var2];
   }
   ...
   public static void Method1371() {
      GlobalModule.INSTANCE.balant.Field2834.close();
   ...
   // $FF: synthetic method
   private static native void Method1377();
}
