...
implements Class422,
Class45 {
    private static final String[] Field1962;
    static long Field1963;
    private static final String[] Field1964;

    public static void Method1364() {
        if (Keyboard.getEventKeyState()) {
            Iterator iterator = ModuleManager.getAllModules().Method1383();
            while (iterator.Method932()) {
                Module a = (Module)iterator.Method933();
                if (a.Method1020() != (Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() + 256 : Keyboard.getEventKey()) || Minecraft.getMinecraft().currentScreen != null) continue;
    ...
    static {
        Class614.Method2232(37, Class398.class);
        Class398.Method1377();
    }

    public static void Method1369(GuiScreen a) {
        Class363.Method608(a);
    }

    private static String Method1357(int n, int n2) {
        int n3 = (n ^ 0x7DA4) & 0xFFFF;
        if (Field1962[n3] == null) {
            int n4;
            char[] cArray = Field1964[n3].toCharArray();
            ...
            Class398.Field1962[n3] = new String(cArray).intern();
        }
        return Field1962[n3];
    }
    ...
    public static void Method1371() {
        GlobalModule.INSTANCE.Field3186.Field2834.close();
        GlobalModule.INSTANCE.fileManager.saveAll();
    }

    public static void Method1372() {
        long a = Sys.getTime() * 1000L / Sys.getTimerResolution();
        int a2 = (int)(a - Field1963);
        Field1963 = a;
        GlobalModule.Field3185 = a2;
    }

    public static void Method1373() {
        if (!GlobalModule.Field3189) {
            new GlobalModule();
        }
    }
    ...
    public String[] Method1360() {
        return new String[]{Class673.Minecraft.Method2340()};
    }
    ...
    public static boolean Method1375() {
        return Class363.Method635();
    }
