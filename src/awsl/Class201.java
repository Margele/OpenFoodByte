...
class Class201
extends Class143 {
    public Class201(float a, ColorModel a2, ColorModel a3) {
        super(a, a2, a3);
    }
    ...
    public void Method380(int[] a, int[] a2, float a3) {
        ...
        if (a6 < a4) {
            ...
            int a13 = a[a6 + 3];
            int a14 = a2[a6 + 3];
            int a15 = 255 - Math.abs((int)(255 - a7 - a8));
            int a16 = 255 - Math.abs((int)(255 - a9 - a10));
            int a17 = 255 - Math.abs((int)(255 - a11 - a12));
