...
public class Class465 implements Class422, Class45 {
   ...
   public String[] Method1360() {
      return new String[]{Class673.BlockRendererDispatcher.Method2340()};
   }

   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ 8759) & '\uffff';
      if (Field2160[var2] == null) {
         char[] var3 = Field2161[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 229;
         ...
         Field2160[var2] = (new String(var3)).intern();
      }

      return Field2160[var2];
   }

   static {
      Class614.Method2232(19, Class465.class);
      Method2168();
   }
   ...
   public static void Method2181(IBlockState a, BlockPos a) {
      EventManager.call(new Class649(a, a));
   }
