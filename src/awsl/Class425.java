...
extends Class426 {
    ...
    public void Method2310(int a2, int a3, float a4) {
        ...
        Class565.Field2640.Method1217("j", (float)(this.Field2050 + this.Field2052 - (double)Class565.Field2640.Method1225("j") - 3.0), (float)(this.Field2051 + 3.0), this.Field2045.getBooleanValue() != false ? a6 : new Color(150, 150, 150, 255).getRGB());
    ...
    public boolean Method2311(int a2, int a3, int a4) {
        if (this.Method2407(a2, a3)) {
            this.Field2045.Method2510(this.Field2045.getBooleanValue() == false);
            return true;
        }
    ...
    public boolean Method2407(int a2, int a3) {
        return (double)a2 >= this.Field2050 + this.Field2052 - 13.0 && (double)a2 <= this.Field2050 + this.Field2052 - 2.0 && (double)a3 >= this.Field2051 + 2.0 && (double)a3 <= this.Field2051 + 13.0;
    }
}