...
implements Class422 {
    ...
    public static void Method3602(int a, int a2) {
        Class363.Method624(a, a2);
    }
    ...
    private static String Method1357(int n, int n2) {
        int n3 = (n ^ 0x6988) & 0xFFFF;
        if (Field1969[n3] == null) {
            int n4;
            char[] cArray = Field1970[n3].toCharArray();
            ...
            Class401.Field1969[n3] = new String(cArray).intern();
        }
        return Field1969[n3];
    }
