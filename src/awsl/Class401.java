...
public class Class401 implements Class422 {
   ...
   static {
      Class614.Method2232(38, Class401.class);
      Method2345();
   }

   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ 27016) & '\uffff';
      if (Field1969[var2] == null) {
         char[] var3 = Field1970[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 184;
         ...
         Field1969[var2] = (new String(var3)).intern();
      }

      return Field1969[var2];
   }

   public String[] Method1360() {
      return new String[]{Class673.MouseHelper.Method2340()};
   }
