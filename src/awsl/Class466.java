...
Class45 {
    ...
    private static String Method1357(int n, int n2) {
        int n3 = (n ^ 0x2BDA) & 0xFFFF;
        if (Field2163[n3] == null) {
            int n4;
            char[] cArray = Field2162[n3].toCharArray();
            ...
            Class466.Field2163[n3] = new String(cArray).intern();
        }
        return Field2163[n3];
    }
    ...
    private static native /* synthetic */ void Method2217();
}