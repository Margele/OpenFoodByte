...
public class Class715 extends GuiButton {
   ...
   public void Method2056(Minecraft a, int a, int a) {
      ...
      if (this.visible) {
         ...
         this.drawCenteredString(a.fontRendererObj, this.displayString, this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2, var6);
         int var7 = Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.displayString);
         RenderUtils.Method1085((double)(this.xPosition + this.width / 2) - this.Field3101.Method292() * (double)this.width / 2.0, (double)(this.yPosition + 22), (double)(this.xPosition + this.width / 2) + this.Field3101.Method292() * (double)this.width / 2.0, (double)(this.yPosition + 22), 1.0F, var5);
      }
