...
public class Class464 implements Class422, Class45 {
   private static final String[] Field2158;
   private static final String[] Field2159;

   public static boolean Method2191() {
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -9371) & '\uffff';
      if (Field2158[var2] == null) {
         char[] var3 = Field2159[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 158;
         ...
         Field2158[var2] = (new String(var3)).intern();
      }

      return Field2158[var2];
   }
   ...
   static {
      Class614.Method2232(16, Class464.class);
      Method2139();
   }
