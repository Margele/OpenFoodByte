...
class Class206 extends Class143 {
   ...
   public void Method380(int[] a, int[] a, float a) {
      ...
      if (var6 < var5) {
         ...
         int var13 = a[var6 + 3];
         int var14 = a[var6 + 3];
         Color.RGBtoHSB(var7, var9, var11, this.Field1176);
         Color.RGBtoHSB(var8, var10, var12, this.Field1177);
         this.Field1177[1] = this.Field1176[1];
         int var18 = Color.HSBtoRGB(this.Field1177[0], this.Field1177[1], this.Field1177[2]);
