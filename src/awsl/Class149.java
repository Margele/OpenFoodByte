...
extends Class143 {
    ...
    public Class149(float a, ColorModel a2, ColorModel a3) {
        super(a, a2, a3);
    }
    ...
    public void Method380(int[] a, int[] a2, float a3) {
        ...
        if (a6 < a4) {
            ...
            int a13 = a[a6 + 3];
            int a14 = a2[a6 + 3];
            Color.RGBtoHSB((int)a7, (int)a9, (int)a11, (float[])this.Field1008);
            Color.RGBtoHSB((int)a8, (int)a10, (int)a12, (float[])this.Field1009);
            this.Field1009[0] = this.Field1008[0];
            this.Field1009[1] = this.Field1008[1];
            int a15 = Color.HSBtoRGB((float)this.Field1009[0], (float)this.Field1009[1], (float)this.Field1009[2]);
