...
public class Class757 extends Class798 {
   ...
   protected int[] Method714(int a, int a, int[] a, Rectangle a3) {
      ...
      Class193.Method1270();
      float a = (float)Math.sin((double)this.Field3308);
      float a = (float)Math.cos((double)this.Field3308);
      int a = 0;
      int a = 0;
      int a;
      if (a < a) {
      ...
      switch (this.Field3314) {
         case 0:
            ...
            a = (this.Field3312.nextInt() & Integer.MAX_VALUE) % a;
            a = (this.Field3312.nextInt() & Integer.MAX_VALUE) % a;
         ...
         case 1:
            ...
            a = (this.Field3312.nextInt() & Integer.MAX_VALUE) % a;
            a = a[a * a + a];
            a = (this.Field3312.nextInt() & Integer.MAX_VALUE) % this.Field3311;
            a = (int)((float)a * a);
            a = (int)((float)a * a);
            a = a - a;
            a = a - a;
