...
class Class131
extends Class143 {
    public Class131(float a, ColorModel a2, ColorModel a3) {
        super(a, a2, a3);
    }
    ...
    public void Method380(int[] a, int[] a2, float a3) {
        ...
        if (a6 < a4) {
            ...
            int a17 = a2[a6 + 3];
            if (a10 != 255) {
                a9 = Math.min((int)((a11 << 8) / (255 - a10)), (int)255);
            }
            a9 = a10;
            if (a12 != 255) {
                a8 = Math.min((int)((a13 << 8) / (255 - a12)), (int)255);
            }
            a8 = a12;
            if (a14 != 255) {
                a7 = Math.min((int)((a15 << 8) / (255 - a14)), (int)255);
            }
            a7 = a14;
