...
public class Class403 implements Class422, Class45 {
   private static final String[] Field1973;
   private static final String[] Field1974;
   ...
   public String[] Method1360() {
      return new String[]{Class673.GuiIngame.Method2340(), Class673.GuiIngameForge.Method2340()};
   }

   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -16352) & '\uffff';
      if (Field1974[var2] == null) {
         char[] var3 = Field1973[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 1;
         ...
         Field1974[var2] = (new String(var3)).intern();
      }

      return Field1974[var2];
   }
   ...
   static {
      Class614.Method2232(32, Class403.class);
      Method2168();
   }
