...
public class Class462 implements Class422, Class45 {
   private static final String[] Field2154;
   ...
   static {
      Class614.Method2232(22, Class462.class);
      Method2168();
   }
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ 2967) & '\uffff';
      if (Field2154[var2] == null) {
         char[] var3 = Field2155[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 71;
         ...
         Field2154[var2] = (new String(var3)).intern();
      }
   ...
   public String[] Method1360() {
      return new String[]{Class673.EntityLivingBase.Method2340()};
   }
