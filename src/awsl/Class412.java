...
public class Class412 extends Class413 {
   ...
   public void Method2369(int a, int a, float a2) {
      ...
      Class565.Field2640.Method1217("j", (float)(this.Field1994 + this.Field1996 - (double)Class565.Field2640.Method1225("j") - 3.0), (float)(this.Field1995 + 3.0), this.Field1989.getBooleanValue() ? a : (new Color(150, 150, 150, 255)).getRGB());
