...
public class Class434 implements Class422, Class45 {
   ...
   public static void Method2343(String a) {
      if (!a.equalsIgnoreCase(Method1357(-4210, -2802)) && !a.equalsIgnoreCase(Method1357(-4212, -27442)) && a.equalsIgnoreCase(Method1357(-4209, -13740))) {
   ...
   public String[] Method1360() {
      return new String[]{Class673.Profiler.Method2340()};
   }
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -4211) & '\uffff';
      if (Field2072[var2] == null) {
         char[] var3 = Field2073[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 29;
         ...
         Field2072[var2] = (new String(var3)).intern();
      }

      return Field2072[var2];
   }

   static {
      Class614.Method2232(41, Class434.class);
      Method1377();
   }
