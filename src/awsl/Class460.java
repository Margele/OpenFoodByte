...
public class Class460 implements Class422, Class45 {
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -20305) & '\uffff';
      if (Field2152[var2] == null) {
         char[] var3 = Field2153[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 164;
         ...
         Field2152[var2] = (new String(var3)).intern();
      }

      return Field2152[var2];
   }
   ...
   // $FF: synthetic method
   private static native void Method2150();
}
