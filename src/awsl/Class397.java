...
public class Class397 extends Class390 {
   ...
   public void Method412(int a, int a1) {
      ...
      String a = this.Method1355((double)this.Field1958, 2);
      a = (new BigDecimal((double)this.Field1958)).setScale(2, 4).floatValue() + "";
      int a = var10000;
      if (this.Field1958 % 1.0F != 0.0F) {
         a = (new BigDecimal((double)this.Field1958)).setScale(2, 4).floatValue() + "";
      }

      a = (new BigDecimal((double)this.Field1958)).setScale(0, 4).toString();
      if (this.Field1959.Method2719() != null) {
         a = a + this.Field1959.Method2719();
      }

      Class565.Field2636.Method1217(a, (float)(this.Field1907 + this.Method1310()) - Class565.Field2635.Method1225(a) - 4.0F, (float)(this.Field1908 + 1), 16777215);
      ...
      float a = (float)(this.Method1310() - 12);
      float a = (this.Field1958 - this.Field1956) / (this.Field1957 - this.Field1956);
      RenderUtils.Method1103((float)(this.Field1907 + 5) + a * a, (float)(this.Field1908 + this.Field1910 - 5), 2.0F, 3.0F, Class707.Method1832());
      if (a.trash() == null) {
         ++a;
         Class390.Method1316(a);
      }
