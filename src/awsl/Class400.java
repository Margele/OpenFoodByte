...
public class Class400 implements Class422, Class45 {
   private static final String[] Field1967;
   private static final String[] Field1968;
   ...
   public String[] Method1360() {
      return new String[]{Class673.NetworkManager.Method2340()};
   }
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ 8524) & '\uffff';
      if (Field1967[var2] == null) {
         char[] var3 = Field1968[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 230;
         ...
         Field1967[var2] = (new String(var3)).intern();
      }
   ...
   static {
      Class614.Method2232(39, Class400.class);
      Method1377();
   }
