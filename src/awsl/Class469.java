...
public class Class469 implements Class422, Class45 {
   private static final String[] Field2168;
   private static final String[] Field2169;
   ...
   public String[] Method1360() {
      return new String[]{Class673.BlockBush.Method2340()};
   }
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -20168) & '\uffff';
      if (Field2169[var2] == null) {
         char[] var3 = Field2168[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 146;
         ...
         Field2169[var2] = (new String(var3)).intern();
      }
   ...
   static {
      Class614.Method2232(15, Class469.class);
      Method2139();
   }
