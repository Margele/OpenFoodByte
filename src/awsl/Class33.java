...
public class Class33 {
   ...
   public static Class33 Method3401(int a, int a) {
      return new Class33(a << 24 | a << 16);
   }

   public static Class33 Method3402(int a, int a, int a) {
      return new Class33(a << 24 | a << 16 | a << 8);
   }

   public static Class33 Method3403(int a) {
      a &= 65535;
      return new Class33(268435456 | a << 8);
   }

   public static Class33 Method3404(int a) {
      return new Class33(369098752 | a << 16);
   }

   public static Class33 Method3405(int a) {
      return new Class33(385875968 | a << 8);
   }

   public static Class33 Method3406(int a) {
      return new Class33(1107296256 | a << 8);
   }

   public static Class33 Method3407(int a, int a) {
      return new Class33(a << 24 | a);
   }
   ...
   public int Method3409() {
      return (this.Field292 & 16711680) >> 16;
   }

   public int Method3410() {
      return (this.Field292 & '\uff00') >> 8;
   }

   public int Method3411() {
      return (short)((this.Field292 & 16776960) >> 8);
   }
   ...
   public int Method3413() {
      return (this.Field292 & 16776960) >> 8;
   }
