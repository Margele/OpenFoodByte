...
public class Class459 implements Class422, Class45 {
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -25784) & '\uffff';
      if (Field2151[var2] == null) {
         char[] var3 = Field2150[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 224;
         ...
         Field2151[var2] = (new String(var3)).intern();
      }

      return Field2151[var2];
   }
