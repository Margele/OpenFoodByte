            ...
            if (a.id == 3) {
                if (!this.Field3067.getText().equalsIgnoreCase("")) {
                    ...
                    if (Class215.Method2649().stream().noneMatch(this::Method1839)) {
                        Class207 a3 = new Class207(this.Field3067.getText());
                        Class215.Method2649().Method2530((Object)a3);
