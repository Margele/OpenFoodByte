...
public class Class430 implements Class422, Class45 {
   ...
   @Class628
   public native void Method2323(Class15 class15, String string);
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -29354) & '\uffff';
      if (Field2063[var2] == null) {
         char[] var3 = Field2065[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 100;
         ...
         Field2063[var2] = (new String(var3)).intern();
      }
   ...
   public String[] Method1360() {
      return new String[]{Method1357(-29353, 20460)};
   }

   static {
      Class614.Method2232(50, Class430.class);
      Method1377();
   }

   public static void Method2325(a[] arr) {
      Field2064 = arr;
   }
