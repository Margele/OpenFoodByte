...
Class45 {
    ...
    private static String Method1357(int n, int n2) {
        int n3 = (n ^ 0xFFFF8D56) & 0xFFFF;
        if (Field2063[n3] == null) {
            int n4;
            char[] cArray = Field2065[n3].toCharArray();
            ...
            Class430.Field2063[n3] = new String(cArray).intern();
        }
        return Field2063[n3];
    }
    ...
    public String[] Method1360() {
        return new String[]{Class430.Method1357(-29353, 20460)};
    }
