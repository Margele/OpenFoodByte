...
public class Class409 implements Class422, Class45 {
   private static final String[] Field1984;
   private static final String[] Field1985;

   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -27282) & '\uffff';
      if (Field1984[var2] == null) {
         char[] var3 = Field1985[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 238;
         ...
         Field1984[var2] = (new String(var3)).intern();
      }

      return Field1984[var2];
   }
   ...
   public String[] Method1360() {
      return new String[]{Class673.GuiContainer.Method2340()};
   }

   static {
      Class614.Method2232(30, Class409.class);
      Method2168();
   }
