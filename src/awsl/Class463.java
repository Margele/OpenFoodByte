...
public class Class463 implements Class422, Class45 {
   private static final String[] Field2156;
   private static final String[] Field2157;
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -7515) & '\uffff';
      if (Field2157[var2] == null) {
         char[] var3 = Field2156[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 137;
         ...
         Field2157[var2] = (new String(var3)).intern();
      }

      return Field2157[var2];
   }

   public String[] Method1360() {
      return new String[]{Class673.BlockGrass.Method2340()};
   }

   static {
      Class614.Method2232(17, Class463.class);
      Method1377();
   }
