...
public class Class399 implements Class422, Class45 {
   private static final String[] Field1965;
   private static final String[] Field1966;

   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -2969) & '\uffff';
      if (Field1965[var2] == null) {
         char[] var3 = Field1966[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 129;
         ...
         Field1965[var2] = (new String(var3)).intern();
      }

      return Field1965[var2];
   }
   ...
   static {
      Class614.Method2232(36, Class399.class);
      Method1363();
   }
