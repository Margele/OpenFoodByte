...
public class Class408 implements Class422, Class45 {
   private static final String[] Field1982;
   private static final String[] Field1983;
   ...
   private static String Method1357(int integer1, int integer2) {
      int var2 = (integer1 ^ -28793) & '\uffff';
      if (Field1983[var2] == null) {
         char[] var3 = Field1982[var2].toCharArray();
         short var10000;
         switch (var3[0] & 255) {
            case 0:
               var10000 = 45;
         ...
         Field1983[var2] = (new String(var3)).intern();
      }

      return Field1983[var2];
   }
   ...
   static {
      Class614.Method2232(31, Class408.class);
      Method2333();
   }

   public static void Method3547(GuiScreen a, String a, IChatComponent a) {
      if (Class363.Method592()) {
         ReflectionUtils2.displayGuiScreen(new Class710(a, a, a));
      }
   ...
   // $FF: synthetic method
   private static native void Method2333();
}
